...
var GameOfLife = function (mock) {
    ...
    this.shapes = {
        ...
        "Tetrix1": [[5, 4, true], [4, 5, true], [5, 5, true], [6, 5, true]],
    };
...
GameOfLife.prototype.initGame = function (gridSize) {
    var self = this;
...
GameOfLife.prototype.nextGeneration = function (callback) {
...
GameOfLife.prototype.addShape = function (selectedShape) {
...
GameOfLife.prototype.initCellGrid = function () {
...
GameOfLife.prototype.__removePrevGenObjects = function () {
    var self = this;
    if(self.mock){
        return;
    }
...
GameOfLife.prototype.drawGrid = function (gameGrid) {
    var self = this;
    if(self.mock){
        return;
    }
...
GameOfLife.prototype._getNeighbours = function (gridSize, posX, posY) {
...
GameOfLife.prototype._getNeighbourCount = function (gameGrid, neighbourList) {
...
GameOfLife.prototype._calculateCellState = function (isCellAlive, activeNeighbourCount) {
...
GameOfLife.prototype._checkNeighbours = function (gameGrid, posX, posY) {
